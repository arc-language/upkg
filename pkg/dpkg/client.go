...
// Client handles HTTP requests to Debian repositories
type Client struct {
	httpClient *http.Client
	userAgent  string
}

// NewClient creates a new Debian repository HTTP client with default timeout
...
func (c *Client) GetGzipped(ctx context.Context, url string) (io.ReadCloser, error) {
	...
	// Return a combined closer that closes both the gzip reader and response body
